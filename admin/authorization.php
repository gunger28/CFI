...
// gungeranton@gmail.com


function codeSending($mail,$level){

    $code = rand(1000, 9999);
    if(!checkMail($mail)){
        // $con = mysqli_connect("localhost", "a316809_1", "mayakavangard", "cfi");
        // $result = mysqli_query($con, "insert into admin(mail,code) values ('$mail','$code')");      
...
function sendCodeToMail($mail, $code){
    ...
    $to = $mail;
    $subject = 'Redacto - code to log in';
    $from = 'Redacto - Change your life.';
